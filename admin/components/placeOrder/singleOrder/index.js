...
const OrderDetails = ({ onClick }) => {
  ...
  return (
    <div className="max-w-[1240px] max-h-[1754px]">
      ...
      <div
        className="w-full relative aspect-[1/1.7] sm:aspect-[1/1.414] bg-white"
        ref={ref}
      >
        <div>
          <div ref={ref}>
            <div className="flex flex-col w-full gap-2">
              <img
                ...
                alt=""
                className="w-[45%] pl-4 pt-2 sm:pl-8 sm:pt-6 sm:pb-2"
              />
              <img
              ...
              <div>
                <div className="flex justify-between items-center pb-1 sm:pb-2 sm:pt-1">
                  ...
                  <div className="w-full flex justify-end items-end text-end">
                    <div class="text-xs md:text-base lg:text-2xl font-semibold flex-column gap-1 mt-2">
                      <p>
                        Date:{" "}
                ...
                <div className="sm:mb-4">
                  <h1 className="text-title text-md md:text-xl font-semibold border-b sm:border-b-2 sm:pb-1">
                    Customer Details:
                  </h1>
                  <div class="text-sm sm:text-base md:text-xl font-semibold flex-column sm:gap-1 sm:mt-2">
                ...
                <div>
                  <h1 className="text-title text-md md:text-xl font-semibold border-b sm:border-b-2">
                    Order Details:
                  </h1>
                  <table className="w-full whitespace-nowrap table-auto border border-gray-100">
                    <thead className="text-[10px]  sm:text-sm font-semibold tracking-wide text-left  uppercase bg-zinc-800 border-slate-800 border text-slate-50">
                      <tr>
                          ...
                          singleOrder.order.map((item, i) => (
                            ...
                            >
                              <td className="px-2 sm:px-4 sm:py-1 font-medium">
                                <span className="text-[10px] sm:text-sm">{`0${
                                  i + 1
                                }.`}</span>
                              </td>
                              <td className="px-2 sm:px-4 sm:py-1 font-medium">
          ...
          <div className="absolute bottom-0 flex flex-col gap-2 sm:gap-5">
            <div className="flex justify-between px-4 sm:px-10 w-full mt-8">
              <div className="text-[10px] sm:text-sm lg:text-xl  text-slate-500">
                [<span className="font-bold text-primary">Note:</span>{" "}
                <span className="text-slate-500 font-semibold">
                  {singleOrder?.customer_details?.note}]
                </span>
              </div>
              <div className="flex flex-col w-1/2 border-t sm:border-t-2 text-[10px] sm:text-base lg:text-2xl">
                ...
                <div className="flex w-full px-4 sm:py-1 justify-between rounded-sm bg-sub">
